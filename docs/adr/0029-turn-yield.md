...
Three distinct skip policies: helpless **auto-pass** (0007), **stack yield** (this stack), **turn yield** (until my turn / until I act). Engine stays intent-only — all three are server chrome.

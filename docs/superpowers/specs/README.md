...
| [buf-proto-lint-breaking](2026-07-27-buf-proto-lint-breaking-design.md) | Design input: CI/local `buf lint` + `buf breaking` (WIRE vs `origin/main`) with major-title / `/v2` hard-break hatch; update `ci-and-release`, wire-protocol, `WIRE_COMPAT.md` at implement time |

...
| [gha-server-verify-sharding](2026-07-26-gha-server-verify-sharding-design.md) | Design input for 2-shard nextest cold `verify-server` wall-clock; update `ci-and-release` at implement time |

...
| [lobby-deck-card-path-and-view-transitions (design)](2026-07-24-lobby-deck-card-path-and-view-transitions-design.md) | Play routes require deck path param; lobby deck card; VT from Your decks tile |

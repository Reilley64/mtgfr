...
- As a player naming a card, I use centered `pending-card-name-modal` with a focused Card name field, optional catalog typeahead suggestions, and Name or Enter.

...
variable "cloudflare_api_token" {
  description = "Cloudflare API token with DNS edit, Zero Trust tunnel edit, Workers Scripts edit, Workers R2 Storage edit, Cache Rules edit, and Cache Purge scope on the example.com zone/account."
  type        = string
  sensitive   = true
}

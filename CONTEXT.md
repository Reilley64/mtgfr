...
- **PlayMotion** — the client module that owns **play-committed** canvas motion (hand→battlefield / hand→stack / leave-stack flights, play entrance parking, play origins). Non-play glides (zone-sourced, creator-origin, opponent-from-avatar) stay on the table surface. See client-game-board-and-interaction spec.

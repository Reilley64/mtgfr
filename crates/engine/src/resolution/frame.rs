...
pub(crate) struct ResolutionFrame {
    ...
    /// Cards this resolution's own [`Effect::SearchLibrary`](crate::Effect::SearchLibrary) step
    ...
    /// `Effect::SearchLibrary` arm), incremented per pick
    ...
    /// ([`Effect::JoinForcesPayMana`](crate::Effect::JoinForcesPayMana)), read by
    ...
    /// An all-players [`Effect::SearchLibrary`](crate::Effect::SearchLibrary) fan-out's (Veteran

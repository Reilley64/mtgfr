...
pub enum StaticEffect {
    ...
    /// pip as well as its own. Gathered by [`Game::mana_substitutions`](crate::Game) and applied by the exact widened payment planner without collapsing independent source buckets.
